...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    // Body
    bufp->fullBit(oldp+1,(vlSelf->top__DOT__count));
    bufp->fullSData(oldp+2,(vlSelf->top__DOT__clkTick__DOT__count),16);
    bufp->fullIData(oldp+3,(vlSelf->top__DOT__stateMachine__DOT__current_state),32);
    bufp->fullIData(oldp+4,((((((((((0U == vlSelf->top__DOT__stateMachine__DOT__current_state) 
